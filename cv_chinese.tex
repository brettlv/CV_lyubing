...
%\myname{Lyu}{Lyu \bibnamedelima B}
\myname{Lyu}{Bing}
...
\leftheader{%
  {\LARGE\bfseries\sffamily 吕兵 Lyu Bing}
  
  \makefield{\faEnvelope[regular]}{\texttt{lyubing@pku.edu.cn}}
  %\makefield{\faEnvelope[regular]}{\texttt{brettlv@foxmail.com}}
  %\makefield{\faTwitter}{\texttt{@example}}
  \makefield{\faIcon{github}}{\url{brettlv.github.io}}
